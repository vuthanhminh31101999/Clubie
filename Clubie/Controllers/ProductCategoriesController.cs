...
namespace Clubie.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductCategoryId,ProductCategoryName")] ProductCategory productCategory)
        {
            ...
            {
                foreach (var i in db.ProductCategories)
                {
                    if (productCategory.ProductCategoryId == i.ProductCategoryId)
                        productCategory.ProductCategoryId = productCategory.ProductCategoryId + 1;
                    else
                        break;
                }
